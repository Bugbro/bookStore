  ...
  return (
    <div className='px-28  py-10 flex items-center justify-evenly bg-[#efefef]'>
        <div className='flex items-center justify-center gap-2'>
            <div className='text-3xl'><i class="fa-solid fa-box-open"></i></div>
            <div>
        ...
        <div className='flex items-center gap-2'>
            <div className='text-3xl'><i class="fa-solid fa-arrows-rotate"></i></div>
            <div>
        ...
        <div className='flex items-center gap-2'>
            <div className='text-3xl'><i class="fa-solid fa-phone"></i></div>
            <div>
