      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="order-2  lg:order-4">
            ...
            <div className="flex bg-white text-black rounded-full py-1 mt-8">
                <input className="flex-1 outline-none pl-4" type="text" placeholder="Email Address" />
                <button className="bg-[#17BD8D] font-semibold text-white mr-2 px-4 py-2 rounded-full cursor-pointer ">Subscribe</button>
            </div>
        </div>
      </div>
